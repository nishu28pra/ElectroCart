                ...
                {/* product deatils */}
                {
                    loading ? (
                        <div className='grid gap-1 w-full'>
                            ...
                            <div className='text-red-600 h-6 lg:h-8  bg-slate-200 animate-pulse flex items-center gap-1 w-full '>

                            </div>

                            <div className='flex items-center gap-2 text-3xl font-medium m-1 h-6 lg:h-8  animate-pulse w-full'>
                            ...
                            <div className='w-full'>
                                ...
                                <p className=' bg-slate-200 rounded animate-pulse h-10 lg:h-12 '></p>
                            </div>
                        </div>
                    ) : (
                        <div className='flex flex-col gap-1'>
                            ...
                            <div className='flex items-center gap-2 text-3xl font-medium m-1'>
