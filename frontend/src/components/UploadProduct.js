...
const UploadProduct = ({
    ...
    // /after uploading  product , then not to refresh
                                ...
                                <div className='flex items-center  gap-2'>
                                    {
                                        data.productImage.map((el,index) => {
                                            return (
                                                ...
                                                <div className='absolute bottom-0 right-0 p-1 text-white text-xs bg-red-600 rounded-full hidden group-hover:block cursor-pointer' onClick={()=>handleDeleteProductImage(index) }>
                                                    <MdDelete/>
                                                </div>
                                                </div>
